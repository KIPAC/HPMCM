...
.. toctree::
   :maxdepth: 2
   :caption: Comparing signal-to-noise of input catalogs
...
.. toctree::
   :maxdepth: 2
   :caption: Comparing sky-coverage of input catalogs
...
.. toctree::
   :maxdepth: 2
   :caption: Matching Metadetect no-shear catalog to object catalog using WCS
...
.. toctree::
   :maxdepth: 2
   :caption: Estimating match efficiecy between metadetect no-shear catalog and object catalog
...
.. toctree::
   :maxdepth: 2
   :caption: Estimating match efficiecy between shear catalgos 
...
.. toctree::
   :maxdepth: 2
   :caption: Reading shear match data directly
...
.. toctree::
   :maxdepth: 2
   :caption: High-level meta analysis of shear calibration
...
.. toctree::
   :maxdepth: 2
   :caption: Deeper dive in to matching shear catalogs
